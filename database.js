...
const DEFAULT_ECONOMY_SETTINGS = {
  ...
  permissions: {
    ...
    command_states: { // État d'activation/désactivation par commande
      "item_info": { enabled: true, slash: true, prefix: true },
      ...
      "sell": { enabled: true, slash: true, prefix: true },
      ...
      "add-inventory": { enabled: true, slash: true, prefix: true },
      "remove-inventory": { enabled: true, slash: true, prefix: true },
